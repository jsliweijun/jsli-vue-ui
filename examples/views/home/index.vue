<template>
  <div>
    <router-link class="btn" tag="button" to="magnifier">放大镜</router-link>
    <router-link class="btn" tag="button" to="checkIn">签到</router-link>
    ...
    <router-link class="btn" tag="button" to="button">button</router-link>
  </div>
</template>
